...
def retrieve_context(user_question: str) -> list[dict[str, Any]]:
    ...
    print("FORMAT INSTRUCTIONS:\n", format_instructions)  # see what's being injected
    
    system_content = QUERY_ANALYSIS_PROMPT.replace(
        "{format_instructions}", 
        format_instructions
    )
    print("FULL SYSTEM PROMPT:\n", system_content)  # verify the replacement worked
    ...
    search_requests: SearchRequests = parser.parse(response.content)
